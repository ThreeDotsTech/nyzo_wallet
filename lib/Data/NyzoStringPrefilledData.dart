...
return this._senderData;
  ...
  getType() {
   ...
   static NyzoStringPrefilledData fromByteBuffer(ByteBuffer buffer) {
        var receiverIdentifier = Uint8List.fromList(buffer.asUint8List().getRange(0, 32).toList());
        int senderDataLength = min(buffer.asByteData().getUint8(32), 32);
        var senderData = Uint8List.fromList(buffer.asUint8List().getRange(33, 33 + senderDataLength).toList());
