...
import 'package:nyzo_wallet/cryptography/algorithms/chacha20.dart';
import 'package:nyzo_wallet/cryptography/mac_algorithm.dart';
import 'package:nyzo_wallet/cryptography/nonce.dart';
...
class _Poly1305 extends MacAlgorithm {
  ...
  MacSink newSink({@required SecretKey? secretKey}) {
    ...
    final r = _Poly1305Sink._bytesToBigInt(Uint8List.fromList(secretKeyBytes), 0, 16);
    final p = _Poly1305Sink._bytesToBigInt(Uint8List.fromList(secretKeyBytes), 16, 32);
