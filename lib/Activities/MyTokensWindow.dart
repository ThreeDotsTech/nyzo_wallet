...
class MyTokensWindow extends StatefulWidget {
  final List<Contact> _contacts;
  const MyTokensWindow(this._contacts);
  @override
  MyTokensWindowState createState() => MyTokensWindowState(_contacts);
}

class MyTokensWindowState extends State<MyTokensWindow> {
  MyTokensWindowState(this.contactsList);
